export default {
    en: {
        message: {
            ...
            donate: 'Donate',
            donateTo: 'Donate to',
            amountToDonate: 'Amount to donate',
            ...
            desapp: 'Applications Development',

            homePhrase: 'Bringing connectivity to all cities ',
    ...
    es: {
        message: {
            ...
            donate: 'Donar',
            donateTo: 'Donar a',
            amountToDonate: 'Cantidad a donar',
            ...
            homePhrase: 'Conectividad desde cualquier punto del pais',

            donation: 'Donacion | Donaciones',
            amount: 'Cantidad',
            comment: 'Comentario',
            date: 'Fecha',
            points: 'Puntos',
